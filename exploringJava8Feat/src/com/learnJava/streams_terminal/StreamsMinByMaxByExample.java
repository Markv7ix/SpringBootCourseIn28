...
public class StreamsMinByMaxByExample {
    ...
    public static void main(String[] args) {
    	...
    	Optional<Student> minByOptStudent = minBy();
        System.out.println(minByOptStudent.isPresent() ? minByOptStudent.get() : "No Student Found");

        Optional<Student> maxByOptStudent = maxBy();
        System.out.println(maxByOptStudent.isPresent() ? maxByOptStudent.get() : "No Student Found");
